...
class CudaCompiler(Compiler):
    ...
    def get_ccbin_args(self, env: Environment) -> T.List[str]:
        key = self.form_compileropt_key('ccbindir')
        ccbindir = env.coredata.optstore.get_value(key, str)
        if ccbindir:
