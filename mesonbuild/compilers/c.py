...
class CCompiler(CLikeCompiler, Compiler):
    ...
    def __init__(self, ccache: T.List[str], exelist: T.List[str], version: str, for_machine: MachineChoice, is_cross: bool,
                 env: Environment, exe_wrapper: T.Optional['ExternalProgram'] = None,
...
class ClangCCompiler(_ClangCStds, ClangCompiler, CCompiler):
    ...
    def __init__(self, ccache: T.List[str], exelist: T.List[str], version: str, for_machine: MachineChoice, is_cross: bool,
                 ...
                 full_version: T.Optional[str] = None):
        CCompiler.__init__(self, ccache, exelist, version, for_machine, is_cross, env, exe_wrapper, linker=linker, full_version=full_version)
...
class EmscriptenCCompiler(EmscriptenMixin, ClangCCompiler):
    ...
    def __init__(self, ccache: T.List[str], exelist: T.List[str], version: str, for_machine: MachineChoice, is_cross: bool,
        ...
        ClangCCompiler.__init__(self, ccache, exelist, version, for_machine, is_cross,
                                env, exe_wrapper=exe_wrapper, linker=linker,
