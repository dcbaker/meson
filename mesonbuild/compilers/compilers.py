...
class Compiler(metaclass=abc.ABCMeta):
    ...
    def __init__(self, exelist: T.List[str], version: str,
                 ...
                 linker: T.Optional['DynamicLinker'] = None, **kwargs: object):
        ...
        self.full_version = kwargs.get('full_version')
    ...
    def compile(self, code: 'mesonlib.FileOrString', extra_args: T.Optional[T.List[str]] = None,
        ...
        try:
            with tempfile.TemporaryDirectory(dir=temp_dir) as tmpdirname:
                ...
                ret = CompileResult()
                _, ret.stdout, ret.stderr = Popen_safe(command_list, cwd=tmpdirname, env=os_env)
