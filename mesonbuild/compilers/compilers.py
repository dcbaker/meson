...
class IntelNixCompiler(GnuLikeCompiler):
    ...
    def compiles(self, *args, **kwargs):
        extra_args = listify(kwargs.get('extra_args') or [])
...
class VisualStudioLikeCompiler(abc.ABC):

    """Shared base class for compilers that try to behave like MSVC."""
    ...
    # Everything up to this point seems relavent to ICC, everything after this
    # is untested
...
class VisualStudioCompiler(VisualStudioLikeCompiler):

    """Specific implementation For Visual Studio based compilers."""
