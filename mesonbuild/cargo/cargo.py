...
if T.TYPE_CHECKING:
    ...
    _TargetEntry = TypedDict(
        '_TargetEntry',
        {
            ...
            'harness': bool,
            'edition': T.Literal['2015', '2018'],
            'crate-type': T.Literal['bin', 'lib', 'dylib', 'staticlib', 'cdylib', 'rlib', 'proc-macro'],
...
class ManifestInterpreter:
    ...
    def __emit_exe_targets(self, builder: NodeBuilder, target: T.Literal['bin', 'test']) -> T.List[str]:
