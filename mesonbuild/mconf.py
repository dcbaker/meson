...
class Conf:
    ...
    def print_conf(self):
        ...
        host_compiler_options = {k: o.host for k, o in self.coredata.compiler_options.items()}
        build_compiler_options = {'build.{}'.format(k): o.build for k, o in self.coredata.compiler_options.items()}
