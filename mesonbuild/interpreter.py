...
class CompilerHolder(InterpreterObject):
    ...
    @FeatureNew('compiler.get_argument_type_method', '0.49.0')
    @noPosargs
    @noKwargs
    def get_argument_type_method(self, args, kwargs):
        return self.compiler.get_argument_type()
